...
function Sidebar() {
    ...
    useEffect(()=>{
      if(!token){
        ...
        axios.get("https://thunder-chill-wound.glitch.me/getUser",{ headers: { "token": token } }).then((e)=>{setName(e.data.message.name); document.getElementById("favicon").href=e.data.message.profileImage; document.getElementById("titleHtml").innerHTML=e.data.message.name})
